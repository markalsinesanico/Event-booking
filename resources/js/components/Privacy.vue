  ...
  <div>
    ...
    <section class="content">
      ...
      <div class="content-text">
        ...
        <p>At Event Vista, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your personal information.</p>

        <h3>1. Information We Collect</h3>
        <p>We collect information that you provide directly to us, including your name, email address, and other profile information.</p>
...
<style scoped>
/* Use the exact same styles as Terms.vue */
/* Header Styles */
.topnav {
